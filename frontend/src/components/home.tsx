    ...
    return (
        <div className='home-nav'>
            <p className='para-style1'>
                ...
                and drag n drop or click to upload a file. Make sure that the file is a valid CSV file for it to
                work
                ...
                <a className="hyper-link"
                   href="https://github.com/JacobN17/Besag-York-Mollie"> Besag-York-Mollie </a>
            </p>
        </div>
    )
}
